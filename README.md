...
<img src="/public/data/Preview.png" alt="Preview" />

## Условие

Получить данные из файла [data.json](public/data/data.json) и вывести их на страницу как это показано на рисунке с левой стороны.
...
Сопоставления id групп и товаров с их названиями находятся в файле [names.json](public/data/names.json).

После вывода данных навесить обработчики для добавления выбранного товара в корзину и удаления из нее. Пример корзины показан на рисунке с правой стороны. Сделать рассчет общей суммы товаров и вывести отдельным полем. Корзина находится на одной и той же странице вместе со списком товаров.
